  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(deleteReceipeAsync.fulfilled, (state, action) => {
        ...
        const foundReceipe = state.storedReceipes.find(receipe => receipe._id === action.payload._id);
      ...
      .addCase(restoreReceipeAsync.fulfilled, (state, action) => {
        ...
        const foundReceipe = state.deletedReceipes.find(receipe => receipe._id === action.payload._id);
      ...
      .addCase(editReceipeAsync.fulfilled, (state, action) => {
        ...
        state.storedReceipes[index].completion_time = action.payload.completion_time;
      })
